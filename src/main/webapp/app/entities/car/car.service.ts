...
export class CarService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/cars';
    ...
    search(req?: any): Observable<HttpResponse<Car[]>> {
        const options = createRequestOption(req);
        return this.http.get<Car[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Car[]>) => this.convertArrayResponse(res));
    }
