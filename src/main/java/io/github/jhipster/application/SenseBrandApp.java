...
public class SenseBrandApp {

    private static final Logger log = LoggerFactory.getLogger(SenseBrandApp.class);

    private final Environment env;

    public SenseBrandApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes SenseBrand.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SenseBrandApp.class);
