...
public class SolutionDetailAnalysisResource {
    ...
    @Timed
    public ResponseEntity<SolutionDetailAnalysis> createSolutionDetailAnalysis(@RequestBody SolutionDetailAnalysis solutionDetailAnalysis) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<SolutionDetailAnalysis> updateSolutionDetailAnalysis(@RequestBody SolutionDetailAnalysis solutionDetailAnalysis) throws URISyntaxException {
