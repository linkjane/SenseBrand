...
public class Brand implements Serializable {
    ...
    @NotNull
    @Column(name = "profile_img_file", nullable = false)
    private String profileImgFile;

    @Column(name = "profile_img_file_url", nullable = false)
    private String profileImgFileUrl;

    @Column(name = "profile_img_file_content_type", nullable = false)
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<BrandSub> brandSubs = new HashSet<>();
    ...
    public Set<BrandSub> getBrandSubs() {
        return brandSubs;
    }

    public Brand brandSubs(Set<BrandSub> brandSubs) {
        this.brandSubs = brandSubs;
        return this;
    }

    public Brand addBrandSub(BrandSub brandSub) {
        this.brandSubs.add(brandSub);
        brandSub.setBrand(this);
        return this;
    }

    public Brand removeBrandSub(BrandSub brandSub) {
        this.brandSubs.remove(brandSub);
        brandSub.setBrand(null);
        return this;
    }

    public void setBrandSubs(Set<BrandSub> brandSubs) {
        this.brandSubs = brandSubs;
    }
