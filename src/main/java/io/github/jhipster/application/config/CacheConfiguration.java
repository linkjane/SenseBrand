...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Designer.class.getName() + ".showImgs", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Designer.class.getName() + ".sentiments", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Designer.class.getName() + ".awards", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Designer.class.getName() + ".ideaMedias", jcacheConfiguration);
            ...
            cm.createCache(io.github.jhipster.application.domain.GrandAward.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Solution.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Solution.class.getName() + ".detailImgs", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Solution.class.getName() + ".detailAnalyses", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Solution.class.getName() + ".correlations", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.SolutionDetailAnalysis.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.SolutionDetailAnalysis.class.getName() + ".detailAnalysisImgs", jcacheConfiguration);
            ...
            cm.createCache(io.github.jhipster.application.domain.Brand.class.getName() + ".brandSubDetails", jcacheConfiguration);
