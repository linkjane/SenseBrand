...
public class DesignerService {
    ...
    /**
     *  get all the designers where IdeaDetails is null.
     *  @return the list of entities
     */
    @Transactional(readOnly = true) 
    public List<Designer> findAllWhereIdeaDetailsIsNull() {
        log.debug("Request to get all designers where IdeaDetails is null");
        return StreamSupport
            .stream(designerRepository.findAll().spliterator(), false)
            .filter(designer -> designer.getIdeaDetails() == null)
            .collect(Collectors.toList());
    }


    /**
     *  get all the designers where Show is null.
     *  @return the list of entities
     */
    @Transactional(readOnly = true) 
    public List<Designer> findAllWhereShowIsNull() {
        log.debug("Request to get all designers where Show is null");
        return StreamSupport
            .stream(designerRepository.findAll().spliterator(), false)
            .filter(designer -> designer.getShow() == null)
            .collect(Collectors.toList());
    }
