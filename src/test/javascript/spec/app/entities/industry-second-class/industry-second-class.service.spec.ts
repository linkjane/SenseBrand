...
describe('Service Tests', () => {
    ...
    describe('IndustrySecondClass Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(IndustrySecondClassService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/industry-second-classes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return IndustrySecondClass', () => {
