...
describe('Service Tests', () => {
    ...
    describe('DesignerIdeaDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DesignerIdeaDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/designer-idea-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DesignerIdeaDetails', () => {
