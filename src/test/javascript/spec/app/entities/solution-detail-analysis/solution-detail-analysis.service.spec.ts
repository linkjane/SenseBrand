...
describe('Service Tests', () => {
    ...
    describe('SolutionDetailAnalysis Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SolutionDetailAnalysisService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/solution-detail-analyses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SolutionDetailAnalysis', () => {
