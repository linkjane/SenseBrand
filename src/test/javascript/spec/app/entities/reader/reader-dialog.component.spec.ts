...
import { ReaderDialogComponent } from '../../../../../../main/webapp/app/entities/reader/reader-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Reader Management Dialog Component', () => {
        let comp: ReaderDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ReaderDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'readerListModification', content: 'OK'});
