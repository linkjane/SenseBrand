...
describe('Service Tests', () => {
    ...
    describe('SolutionCorrelation Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SolutionCorrelationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/solution-correlations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SolutionCorrelation', () => {
