...
public class IndustryResourceIntTest {
    ...
    private static final String DEFAULT_INVENTORY_FILE = "AAAAAAAAAA";
    private static final String UPDATED_INVENTORY_FILE = "BBBBBBBBBB";
    ...
    public void createIndustry() throws Exception {
        ...
        assertThat(testIndustry.getInventoryFile()).isEqualTo(DEFAULT_INVENTORY_FILE);
    ...
    public void getAllIndustries() throws Exception {
        ...
        restIndustryMockMvc.perform(get("/api/industries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].inventoryFile").value(hasItem(DEFAULT_INVENTORY_FILE.toString())))
    ...
    public void getIndustry() throws Exception {
        ...
        restIndustryMockMvc.perform(get("/api/industries/{id}", industry.getId()))
            ...
            .andExpect(jsonPath("$.inventoryFile").value(DEFAULT_INVENTORY_FILE.toString()))
    ...
    public void updateIndustry() throws Exception {
        ...
        updatedIndustry
            ...
            .inventoryFile(UPDATED_INVENTORY_FILE)
        ...
        assertThat(testIndustry.getInventoryFile()).isEqualTo(UPDATED_INVENTORY_FILE);
