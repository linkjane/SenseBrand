...
public class SolutionDetailAnalysisResourceIntTest {
    ...
    public void createSolutionDetailAnalysis() throws Exception {
        ...
        assertThat(testSolutionDetailAnalysis.getImgFile()).isEqualTo(DEFAULT_IMG_FILE);
    ...
    public void checkImgFileIsRequired() throws Exception {
        int databaseSizeBeforeTest = solutionDetailAnalysisRepository.findAll().size();
        // set the field null
        solutionDetailAnalysis.setImgFile(null);

        // Create the SolutionDetailAnalysis, which fails.
        ...
        List<SolutionDetailAnalysis> solutionDetailAnalysisList = solutionDetailAnalysisRepository.findAll();
        assertThat(solutionDetailAnalysisList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateSolutionDetailAnalysis() throws Exception {
        ...
        assertThat(testSolutionDetailAnalysis.getImgFile()).isEqualTo(UPDATED_IMG_FILE);
