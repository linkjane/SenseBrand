...
public class IndustrySecondClassResourceIntTest {
    ...
    public static IndustrySecondClass createEntity(EntityManager em) {
        IndustrySecondClass industrySecondClass = new IndustrySecondClass()
            .name(DEFAULT_NAME);
        // Add required entity
        IndustryFirstClass industryFirstClass = IndustryFirstClassResourceIntTest.createEntity(em);
        em.persist(industryFirstClass);
        em.flush();
        industrySecondClass.setIndustryFirstClass(industryFirstClass);
